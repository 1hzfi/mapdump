      ...
      <div className="col-sm">
        <h4>
          ...
          {resent && (
            <>
              {" "}
              <span className="badge badge-warning">Verification resent</span>
            </>
          )}
        </h4>
      </div>
          ...
          <div>
            <form className="form-group" onSubmit={addEmail}>
              <div className="form-group">
                <label htmlFor="staticEmail" className="sr-only">
                  Email
                </label>
                <input
                  type="email"
                  ...
                  className={
                    "form-control" + (errorsAdding.email ? " is-invalid" : "")
                  }
                  id="staticEmail"
